 ...
 <div id="loader"></div>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <img src="img/afriwood-logo.png" width="100%" height="auto;" class="img-fluid" alt="">
      </a>
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_document.php" class="list-group-item list-group-item-action waves-effect">
          ...
          <a href="https://shutterbirdng.com/gallery/gallery.php" target="_blank" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-file-medical"></i> Gallery</a>

          <a href="https://webmail-p35.web-hosting.com/" target="_blank" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-file-medical"></i> View Emails</a>
